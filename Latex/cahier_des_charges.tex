...
\includegraphics[width=9cm]{Ressources/UParisCitelogo.jpg}

{\Large Projet de programmation}\\[0.2cm]

\vspace*{1.5cm}

\rule{.9\linewidth}{.6pt}\\[0.4cm]
{\huge \bfseries Cahier des charges\par}
{\Large Projet L2I1 - Tamagotchi}\vspace{0.4cm}
...
\makebox[5cm]{Marwan DENAGNON (22202193)}\\
\makebox[5cm]{Lina BOUGUETTAYA (????????)}\\
\makebox[5cm]{Abhijeet SINGH (?????????)}\\
\makebox[5cm]{Yasmine DEHOUCHE (?????????)}\\

\vspace*{2cm}

\begin{tabular}{ll}
{\it Encadrant:}   & ~~Camille Kurtz \\
{\it Responsable de l'UE:} & ~~David Janiszek
\end{tabular}

\vspace*{2.5cm}

Année 2024-2025\\[4cm] % Date
