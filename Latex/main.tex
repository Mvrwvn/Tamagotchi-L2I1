...
\insererfigure{maquette/firstpage.png}{3cm}{Page d'accueil (choix connexion/inscription)}{Page d'accueil (choix connexion/inscription}
\insererfigure{maquette/app_loading.png}{3cm}{Page Chargement}{Page de chargement}
\insererfigure{maquette/Adoption_animal.png}{3cm}{Page inscription}{Page inscription}
\insererfigure{maquette/backup.png}{3cm}{Page des paramètres}{Page des paramètres}
\insererfigure{maquette/page_principal.png}{3cm}{Page principal du jeu}{Page principal du jeu}
