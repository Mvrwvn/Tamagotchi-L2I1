...
-----------------------------
    ...
    Que fait le code ? : Verfie l'execution de la page réinitialisation
-----------------------------
*/
public class RenitialisationMdpActivityTest {
    ...
    public void testLoads() {
        try(ActivityScenario<RenitialisationMdpActivity> scenario = ActivityScenario.launch(RenitialisationMdpActivity.class)) {
