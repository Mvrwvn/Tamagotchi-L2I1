...
import com.example.tamagotchi.viewmodel.CreerMimichiViewModel;
...
public class CreerMimichiActivity extends AppCompatActivity {
    ...
    private CreerMimichiViewModel creerMimichiViewModel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        creerMimichiViewModel = new ViewModelProvider(this).get(CreerMimichiViewModel.class);
        creerMimichiViewModel.getMessageLiveData().observe(this, message -> {
        ...
        ajouterButton.setOnClickListener(v -> {
            ...
            creerMimichiViewModel.ajouterTamagotchi(tamagotchi);
        });
